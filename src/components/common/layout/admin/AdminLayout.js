// components/common/layout/admin/AdminLayout.js
...
const AdminLayout = ({ children, ...props }) => {
 ...
 const menuItems = [
   ...
   },
   {
     name: '출석',
     icon: (
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-day" viewBox="0 0 16 16">
