            ...
            {history.length > 0 ? (
              history.map((record) => (
                <tr key={record.id} className="text-center">
                  <td
                    className="border border-gray-300 px-4 py-2">{record.courseName}</td>
                  <td
                    className="border border-gray-300 px-4 py-2">{record.adminName}</td>
                  <td
                    className="border border-gray-300 px-4 py-2">{record.enrollDate}</td>
                  <td
                    className="border border-gray-300 px-4 py-2">{record.endDate}</td>
