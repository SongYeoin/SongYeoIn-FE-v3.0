  ...
  return (
    <div className="w-full h-full left-0 top-0 absolute overflow-hidden bg-white flex justify-center items-center">
      ...
      >
        ...
        >
          {/* 아이디 입력칸 */}
          <div className="w-[490px] h-[74px] rounded-[20px] bg-[#fffefe]/50 flex flex-row gap-5 p-5">
            <svg
              width="45"
              height="44"
              viewBox="0 0 45 44"
            ...
            <input
              className="w-[380px] h-9 text-[29px] text-left text-black bg-transparent"
              placeholder="ID"
              value={id}
        ...
        <div className="w-[490px] h-[74px] rounded-[20px] bg-[#fffefe]/50 flex items-center gap-5 p-5 focus-within:ring-2 focus-within:ring-[#1e2d1f]">
          ...
          {/* 비밀번호 입력칸 */}
          <div className="w-[490px] h-[74px] rounded-[20px] bg-[#fffefe]/50 flex flex-row gap-4 p-5">
            <svg
              width="49"
              height="43"
              viewBox="0 0 49 43"
